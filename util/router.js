...
function sendRequest(txnId, config, res) {
	...
	return new Promise((resolve, reject) => {
		...
		let pathArray = ["/b2bgw/downloadfile", "/workflow/file/download/{id}", "/bm/{app}/download/{type}/{id}", "/rbac/usr/bulkCreate/{id}/download", "/bm/ieg/download/{type}", "/bm/{app}/download/appagent/{id}/{type}", "/bm/{app}/download/partneragent/{id}/{type}", "/sec/identity/{appName}/fetch/download", "/sec/identity/{appName}/csr", "/sec/identity/{appName}/certificate/download", "/sec/keys/download/IEG", "/sec/keys/download/CA"];
